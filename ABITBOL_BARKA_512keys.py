...
dossier_sortie = "dossier_cles512"
chemin_fichier_premiers = "premiers512.txt"
...
with open(chemin_fichier_premiers, "w") as fichier_premiers:
    for i in range(nombre_cles_a_generer):
        ...
        # Génère une clé RSA de 512 bits et la stocke dans un fichier texte
        chemin_fichier_cle = os.path.join(dossier_sortie, f"cle_{i}.txt")
        os.system(f"openssl genrsa 512 > {chemin_fichier_cle}")
